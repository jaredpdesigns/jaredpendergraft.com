<template>
  <main :class="$options.name">
    <article
      :class="[
        $options.name + '__wrap',
        'oomph__v--l padding__bottom--l padding__left--m padding__right--m width__xxl',
      ]"
    >
      <header class="type__align--center">
      ...
      <p class="border__top color__border--base--light padding__top--m">
        {{ consultant }}
      </p>
