  ...
  <article>
    ...
    <figure>
      <Freeform
        ...
        img="yodlerestaurants/yodlerestaurants-logo.svg"
        :height="266"
        :width="784"
      />
    </figure>
    ...
    <figure>
      <Freeform
        ...
        img="yodlerestaurants/yodlerestaurants-app-icon.svg"
        :height="160"
        :width="160"
      />
    </figure>
    ...
    <figure>
      <Tablet
        ...
        img="yodlerestaurants/yodlerestaurants-ipad-review-1.jpg"
      />
    </figure>
    <figure>
      <Tablet
        alt="Yodle Restaurants app review filled"
        img="yodlerestaurants/yodlerestaurants-ipad-review-2.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Yodle Restaurants iPad app main review screen.</em>
      </p>
    </blockquote>
    ...
    <figure>
      <Tablet
        ...
        img="yodlerestaurants/yodlerestaurants-ipad-settings.jpg"
      />
    </figure>
    <figure>
      <Tablet
        alt="Yodle Restaurants coupon validation"
        img="yodlerestaurants/yodlerestaurants-ipad-coupons.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Yodle Restaurants iPad app settings and coupon redemption screens.</em>
      </p>
    </blockquote>
    ...
    <figure>
      <Browser
        ...
        img="yodlerestaurants/yodlerestaurants-reviews.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>A broad set of filters makes sorting and responding to reviews easy.</em>
      </p>
    </blockquote>
    ...
    <figure class="multi">
      <Phone
        ...
        img="yodlerestaurants/yodlerestaurants-phone-filters.jpg"
      />
      <Phone
        alt="Yodle Restaurants mobile edit review 1"
        img="yodlerestaurants/yodlerestaurants-phone-edit-review-1.jpg"
      />
      <Phone
        alt="Yodle Restaurants mobile edit review 2"
        img="yodlerestaurants/yodlerestaurants-phone-edit-review-2.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Mobile views for filtering and editing reviews.</em>
      </p>
    </blockquote>
    <figure class="multi">
      <Phone
        alt="Yodle Restaurants mobile edit email templates"
        img="yodlerestaurants/yodlerestaurants-phone-edit-email-template.jpg"
      />
      <Phone
        alt="Yodle Restaurants mobile restaurant details"
        img="yodlerestaurants/yodlerestaurants-phone-restaurant-details.jpg"
      />
      <Phone
        alt="Yodle Restaurants mobile restaurant social accounts"
        img="yodlerestaurants/yodlerestaurants-phone-restaurant-social.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Edit email incentive templates and restaurant location information easily.</em>
      </p>
    </blockquote>
    <figure>
      <Browser
        alt="Yodle Restaurants customer dashboard statistics and widget embed code"
        img="yodlerestaurants/yodlerestaurants-widget.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Take your reviews with you! Easily embed a lovely looking collection of reviews showing your best reviews on your personal site.</em>
      </p>
    </blockquote>
    ...
    <figure>
      <Browser
        ...
        img="yodlerestaurants/yodlerestaurants-admin-initial.jpg"
      />
    </figure>
    <figure>
      <Browser
        alt="Yodle Restaurants admin panel restaurant details"
        img="yodlerestaurants/yodlerestaurants-admin-details.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>All customer data can be managed within a well organized Admin dashboard used by Yodle professionals. Whether tracking devices or helping customer understand what their username might be, the full-featured dashboard brings the tool full circle.</em>
      </p>
    </blockquote>
    ...
    <figure>
      <Browser
        ...
        img="yodlerestaurants/yodlerestaurants-marketing-site-1.jpg"
      />
    </figure>
    <figure>
      <Tablet
        alt="Yodle Restaurants marketing site"
        img="yodlerestaurants/yodlerestaurants-marketing-site-2.jpg"
      />
    </figure>
    <figure>
      <Tablet
        alt="Yodle Restaurants marketing site"
        img="yodlerestaurants/yodlerestaurants-marketing-site-3.jpg"
      />
    </figure>
    <blockquote>
      <p>
        <em>Yodle Restaurants marketing site.</em>
      </p>
    </blockquote>
  </article>
</template>
