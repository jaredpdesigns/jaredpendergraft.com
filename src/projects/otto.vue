...
<article>
  ...
  <p>The overall approach I took to the brand-alignment was to focus on what was working and to smooth out the edges. I wanted to bring a human touch to an austere industry focusing on an easy-to-use UI that had personality. The two primary typefaces I chose for the project were <a href="https://fonts.google.com/specimen/Source+Sans+Pro">Source Sans Pro</a> and <a href="https://fonts.google.com/specimen/Nunito">Nunito</a>—a lovely rounded sans-serif that added a nice disposition to the brand.</p>
  ...
  <figure>
    <Freeform alt="OTTO logotypes" img="otto/otto-logo.svg" :height="136" :width="784"/>
  </figure>
  <blockquote>
    <p><em>Primary and secondary logotypes.</em></p>
  </blockquote>
  <figure>
    <Freeform alt="OTTO iOS app icon" img="otto/otto-app-icon.svg" :height="160" :width="160"/>
  </figure>
  <blockquote>
    <p><em>iOS app icon introducing a gradient treatment of the two primary highlight brand colors.</em></p>
  </blockquote>
  ...
  <figure>
    <Freeform alt="OTTO color palette" img="otto/otto-colors.svg" :height="192" :width="784"/>
  </figure>
  <blockquote>
    <p><em>While a majority of the interface in the application is white and gray, color plays a big role with action-based UI elements. It was important for any secondary colors to feel as warm and natural as the selection of typefaces.</em></p>
  </blockquote>
  <h2>Icon System</h2>
  ...
  <figure>
    <Freeform alt="OTTO app icon system" img="otto/otto-icons.svg" :height="192" :width="784"/>
  </figure>
  <blockquote>
    <p><em>OTTO’s icon system borrows from the softness of the logotype and general clarity of form—even at small sizes.</em></p>
  </blockquote>
  <h2>Application</h2>
  ...
  <figure class="multi">
    <Phone alt="Find a provider 1" img="otto/otto-find-provider-1.jpg"/>
    <Phone alt="Find a provider 2" img="otto/otto-find-provider-2.jpg"/>
    <Phone alt="Find a provider 3" img="otto/otto-find-provider-3.jpg"/>
  </figure>
  <blockquote>
    <p><em>For first-time users we reduced a lot of the friction of finding a new provider by helping narrow the search query and showing providers who are available soonest with the next available appointment.</em></p>
  </blockquote>
  <figure>
    <Browser alt="Find a provider - Care Team" img="otto/otto-find-provider-care-team.jpg"/>
  </figure>
  <blockquote>
    <p><em>For users who like seeing the same providers consistently, we grouped saved providers into a Care Team—enabling a broader amount of appointment availability.</em></p>
  </blockquote>
  <figure class="multi">
    <Phone alt="Provider profile" img="otto/otto-provider-profile.jpg"/>
    <Phone alt="Upcoming appointments" img="otto/otto-appointments-upcoming.jpg"/>
    <Phone alt="Cancel appointment" img="otto/otto-cancel-appointment.jpg"/>
  </figure>
  <blockquote>
    <p><em>If users want to learn more about providers they can view their profiles. Additionally it’s easy to view upcoming appointments and reschedule or cancel an appointment.</em></p>
  </blockquote>
  <figure>
    <Browser alt="Provider consultation" img="otto/otto-consultation-provider.jpg"/>
  </figure>
  <blockquote>
  ...
  <figure>
    <Browser alt="Practice scheduling" img="otto/otto-schedule-practice.jpg"/>
  </figure>
  <blockquote>
    <p><em>For busy practices scheduling multiple providers for consultations is easy. Having an overview of the upcoming week is very helpful.</em></p>
  </blockquote>
  <figure class="multi">
    <Phone alt="Schedule add" img="otto/otto-schedule-add.jpg"/>
    <Phone alt="Schedule edit" img="otto/otto-schedule-edit.jpg"/>
    <Phone alt="Schedule new patients" img="otto/otto-new-patient.jpg"/>
  </figure>
  <blockquote>
    <p><em>Practice administrators can add or edit provider availability as well as schedule new patients.</em></p>
  </blockquote>
  <h2>Development</h2>
